 ...
 *
 * <p>This settings sub screen handles the following input preferences. - Auto-capitalization - Show
 * separate number row - Hide special characters - Hide language switch key - Switch to other
