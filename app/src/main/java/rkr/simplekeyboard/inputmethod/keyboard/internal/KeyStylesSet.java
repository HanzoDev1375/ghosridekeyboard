...
public final class KeyStylesSet {
  ...
  private static final class DeclaredKeyStyle extends KeyStyle {
    ...
    public DeclaredKeyStyle(
        final String parentStyleName,
  ...
  public void parseKeyStyleAttributes(
      final TypedArray keyStyleAttr, final TypedArray keyAttrs, final XmlPullParser parser)
    ...
    final String parentStyleInAttr =
        keyStyleAttr.getString(R.styleable.Keyboard_KeyStyle_parentStyle);
    ...
    final String parentStyleName =
        (parentStyleInAttr == null) ? EMPTY_STYLE_NAME : parentStyleInAttr;
